            ...
            <div className='min-h-screen grid place-items-center'>
                <div className='w-[80%] flex flex-col items-center'>
                    <div className='flex items-center gap-4'>
                        ...
                        <div className='text-violet-300 uppercase text-4xl font-bold text-center translate-y-2'>
                            {/* <div className='text-violet-300 uppercase text-2xl font-bold text-center translate-y-2 bg-gradient-to-r from-violet-500  to-white/0 bg-clip-text text-transparent'> */}
