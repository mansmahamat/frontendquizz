    ...
    return (
        <div className='min-h-screen grid place-items-center'>
            <div className='border rounded border-white/0 '>
                <h1 className='text-center text-5xl md:text-7xl font-bold bg-gradient-to-r  bg-clip-text text-white q-animate-gradient'>
                    Frontend Quiz
                </h1>
                ...
                <div class=" flex flex-col justify-center py-12 sm:px-6 lg:px-8 px-6">
